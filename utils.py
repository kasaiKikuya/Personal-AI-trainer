...
# trả lại body_part, x, y dưới dạng dataframe
...
def score_table(exercise, counter, status):
    ...
    cv2.putText(score_table, "Activity : " + exercise.replace("-", " "),
                (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (182, 158, 128), 2,
                cv2.LINE_AA)
    cv2.putText(score_table, "Counter : " + str(counter), (10, 115),
                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (182, 158, 128), 2, cv2.LINE_AA)
    cv2.putText(score_table, "Status : " + str(status), (10, 150),
                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (182, 158, 128), 2, cv2.LINE_AA)
